...
class CI_Image_lib {
	...
	function initialize($props = array())
	{
		...
		if (function_exists('realpath') AND @realpath($this->source_image) !== FALSE)
		{
            ...
            $full_source_path = str_replace(DS . DS , DS, realpath($this->source_image));
            //echo $full_source_path; exit;
		}
		else
		{
		...
		$x = explode( DS , $full_source_path);
        
        //echo '<pre> ' . DS . print_r($x, true) .'</pre>';exit;
		...
		{
			//'/'
            if (strpos($this->new_image, DS) === FALSE)
			{
				$this->dest_folder = $this->source_folder;
			...
			else
			{
                ...
                if (function_exists('realpath') AND @realpath($this->new_image) !== FALSE)
				{
					...
					$full_dest_path = str_replace(DS . DS , DS, realpath($this->new_image));
				}
				else
				{
				...
				{
					$this->dest_folder = $full_dest_path. DS;
					$this->dest_image = $this->source_image;
				}
				else
				{
		...
		if ($this->wm_overlay_path != '')
		{
			...
			$this->wm_overlay_path = str_replace(DS . DS, DS, realpath($this->wm_overlay_path));
		}
