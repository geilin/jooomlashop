...
<div class="search"><?php if ($this->params->get('show_page_title', 1)) : ?>
<h1 class="title_page_sub "><?php echo $this->escape($this->params->get('page_title')); ?>
</h1>
<div class="h_10"></div>
<?php endif; ?> <?php echo $this->loadTemplate('form'); ?> <?php if(!$this->error && count($this->results) > 0) :
