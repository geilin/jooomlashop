	...
	<div id="ja-container2" class="clearfix">
		...
		<div id="ja-content">
            ...
            <div style="border:1px solid red;">
                ...
                <h1>San pham dang khuyen mai here</h1>
                <image src="<?php echo $tmpTools->templateurl(); ?>/images/selloff.jpg" alt="selloff"/>
                <jdoc:include type="module" name="home_page_slide" />
            </div>
			<?php endif ; ?>
